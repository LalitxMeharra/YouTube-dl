...
# Using android/ios client bypasses YouTube's "Sign in to confirm you're not a bot"
# check, which normally blocks scraping from datacenter/cloud IPs like Vercel's.
YDL_OPTS = {
    'quiet': True,
    'no_warnings': True,
    'skip_download': True,
